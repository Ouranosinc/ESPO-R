...
None of these issues are caused by the ESPO-R5 workflow, but rather from missing data in the sources.
For more context, see: https://na-cordex.org/missing-data.html.
...
and second, the entire simulation is corrected with these factors (adjustment step). The reference period chosen here were years 1981-2010.
...
When new versions of ESPO-R will be released, previous versions may be pulled from the server. [Please contact us](mailto:scenarios@ouranos.ca) if you wish to obtain these.

## Acknowledgements
We acknowledge the World Climate Research Programme's ([WCRP](https://www.wcrp-climate.org/)) Working Group on Regional Climate
([WGRP](https://www.wcrp-climate.org/regional-climate)) and Working Group on Coupled Modelling ([WGCM](https://www.wcrp-climate.org/wgcm-overview)), former coordinating body of CORDEX and responsible panel for CMIP5.
We also thank the climate modelling groups (listed in Table 1) for producing and making available their model output.
We also acknowledge the U.S. Department of Defense [ESTCP](https://serdp-estcp.org/about/programs?Id=cf88fbc0-872d-4b9b-9673-d08833e7bb9a)
for its support of the NA-CORDEX data archive,

The  CRCM5  data  has  been generated  and  supplied  by  Ouranos. The Canadian Regional Climate Model (CRCM5; Martynov
et al. 2013, Separovic et al. 2013) was developed by the [ESCER Centre](https://escer.uqam.ca/) at [UQAM](https://uqam.ca/)
(Université du Québec à Montréal) in collaboration with Environment and Climate Change Canada ([ECCC](https://www.canada.ca/en/environment-climate-change.html)).
CRCM5 computations were made on the supercomputers beluga and narval managed by [Calcul Québec](https://www.calculquebec.ca/en/) and the [Digital Research Alliance of Canada](https://alliancecan.ca/en). 
The operation of this supercomputer received financial support from Innovation, Science and Economic Development Canada ([ISED](https://ised-isde.canada.ca/site/ised/en))
and the Ministère de l’Économie, de l’Innovation, et de l'Énergie du Québec ([MEIE](https://www.economie.gouv.qc.ca/)).

The ESPO-R5 data was generated using ERA5-Land hourly data from 1950 to present (https://doi.org/10.24381/cds.e2161bac)
